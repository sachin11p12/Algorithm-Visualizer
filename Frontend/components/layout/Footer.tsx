...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="w-full border-t border-border/40 bg-card/50 backdrop-blur-sm mt-8">
      ...
      {/* Bottom Bar */}
      <div className="border-t border-border/40 px-6 lg:px-10 py-4 max-w-[1600px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-2 text-sm text-muted-foreground">
